...
Route::middleware('auth:sanctum')->post('/tasks/reorder', [App\Http\Controllers\TaskController::class,'reorder']);
Route::middleware('auth:sanctum')->post('/tasks', [App\Http\Controllers\TaskController::class, 'store']);
Route::middleware('auth:sanctum')->delete('/boards/{task}', [App\Http\Controllers\TaskController::class, 'boardsDestroy']);
